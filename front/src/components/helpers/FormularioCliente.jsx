    ...
    <section className="contenedorPrincipal">
      ...
      <form action="" className="formulario">
        <fieldset>
          ...
          <input class="form_item" type="text" placeholder="Nombres" />
          <input class="form_item" type="text" placeholder="Apellidos" />
          <input
            class="form_item"
            type="date"
        ...
        <fieldset>
          ...
          <select name="favoriteOnly" id="favoriteOnly" className="form_item">
          ...
          <input class="form_item" type="text" placeholder="Dirección" />
